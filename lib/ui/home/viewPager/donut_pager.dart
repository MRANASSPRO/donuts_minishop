...
import 'package:donuts_minishop/ui/home/viewPager/page_view_indicator.dart';
...
class _DonutPagerState extends State<DonutPager> {
  List<DonutPageItem> pages = [
    DonutPageItem(imgUrl: Utils.donutPromo1, logoImgUrl: Utils.donutLogoWhiteText),
    DonutPageItem(imgUrl: Utils.donutPromo2, logoImgUrl: Utils.donutLogoWhiteText),
    DonutPageItem(imgUrl: Utils.donutPromo3, logoImgUrl: Utils.donutLogoWhiteText),
  ];
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: MediaQuery.of(context).size.height / 3 -
          20, // this size is measured with px
      child: Column(
        children: [
          Expanded(
            child: PageView(
              ...
              children: List.generate(pages.length, (index) {
                DonutPageItem currentPage = pages[index];
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: NetworkImage(currentPage.imgUrl!), fit: BoxFit.cover),
                  ),
